...
This module runs on an **AI-Thinker ESP32-CAM** (OV2640 sensor + 4 MB external PSRAM) and provides live video streaming, flashlight illumination, and hardware sync with the Main ESP32.
